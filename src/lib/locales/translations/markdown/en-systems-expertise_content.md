...
modern applications must coexist, such as supporting a shared theming model
across an older PHP codebase and a newer React application backed by the same
configuration.

### Legacy and heterogeneous environments

Work across heterogeneous environments, including PHP, Java, Node, and modern
