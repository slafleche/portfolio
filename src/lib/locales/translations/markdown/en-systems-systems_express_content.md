...
It started as an early test in [abbr:AI] collaboration — it took work, but we
ended up with something interesting.

The arch is [abbr:SVG]-based but calculated, not drawn, which gives it
