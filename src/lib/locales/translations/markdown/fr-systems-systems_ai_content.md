...
TODO numéroté et livre ses changements dans sa propre branche ou tâche de
refactor (comme la migration MeasurementKit → CSS Calipers).

Parce que la structure est déterministe, la collaboration reste nette. L’IA
peut aller vite — écrire le boilerplate, étendre des helpers ou tester des
refactors — sans franchir les frontières ni casser la sécurité de types. Les
mêmes garde-fous qui encadrent les humains s’appliquent aussi à elle.

Le but n’est pas l’automatisation pour l’automatisation, mais une boucle de
développement plus rapide et vérifiable où humain et IA travaillent dans la
même architecture.
