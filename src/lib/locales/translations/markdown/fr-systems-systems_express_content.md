...
L’arche a commencé comme une expérience, quelque chose que [abbr:CSS] seul
n’exprimait pas proprement.  
...
La forme est basée sur du [abbr:SVG] mais calculée à partir de variables
partagées.  
