...
function buildSrcSet(variants?: PosterVariants[keyof PosterVariants]) {
...
export default function VideoByNameClient({
	...
	React.useEffect(() => {
		...
		let hls: InstanceType<typeof import('hls.js')['default']> | null =
			null;
		let cancelled = false;
	...
	return (
		...
		>
			...
			<div className={contentWrapClassName} style={posterContainerStyle}>
				{posterImage ? (
					<picture>
						{avifSrcSet ? (
							<source
