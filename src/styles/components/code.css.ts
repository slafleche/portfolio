...
export const mock = style({
  ...
  ...borders({
    top: {
      ...
      color: textStyleVars.code.block.borders.color.alpha(0.3),
    },
    right: textStyleVars.code.block.borders,
    bottom: textStyleVars.code.block.borders,
    left: textStyleVars.code.block.borders,
    radius: {
      north: m(0),
      south: textStyleVars.code.block.borders.radius,
    },
  }),
  selectors: {
    '&::after': {
...
// unset in decorative mock code blocks
globalStyle(
  'pre[data-ui="mock-code-block"] code[data-code="block"] > p:not([data-first="true"])',
  {
    ...margins({
      top: mEm(1),
    }),
