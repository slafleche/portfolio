...
- Do not coerce measurement values to primitive numbers/strings inside tokens; coercion only happens at adapter/emission boundaries using sanctioned css-calipers measurement APIs.
