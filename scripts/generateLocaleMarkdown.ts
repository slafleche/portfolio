...
export const MARKDOWN_FILE_PATTERN =
...
export function buildFileContents(
  ...
  const localeUnion = AVAILABLE_LOCALES.map(
    (locale) => `'${locale}'`,
  ).join(' | ');
  ...
  const serializedMessages =
    serializeMarkdownMessages(completeMessages);
...
export function serializeMarkdownMessages(
