...
- UI with [React](https://reactjs.org/) (19.x)
- App framework: [Next.js](https://nextjs.org/) (16.x, App Router)
- Styling with [Vanilla-Extract](https://vanilla-extract.style/) + `css-calipers`
- Accessible primitives by [Radix UI](https://www.radix-ui.com/)
...
- When updating `fonts.config.json`, regenerate the Google Fonts URL bundle and
  ...
  ```bash
  tsx scripts/generateFontUrls.mts
  VERIFY_FONT_URLS=true tsx scripts/generateFontUrls.mts
  ```
